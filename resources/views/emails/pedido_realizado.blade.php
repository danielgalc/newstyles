...
<body>
    <div class="container flex flex-col items-center justify-center">
        ...
        <p>Tu pedido ha sido recibido y está en proceso. Aquí tienes los detalles de tu pedido:</p>
        ...
        <p><strong class="label">Precio total:</strong> {{ $pedido->precio_total }}.00 &euro;</p>
