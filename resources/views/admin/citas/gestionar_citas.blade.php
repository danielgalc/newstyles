    ...
    <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-teal-200 cursor-pointer w-full">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center" data-modal-toggle="edit_cita_modal_{{ $cita->id }}" data-modal-target="edit_cita_modal_{{ $cita->id }}">{{ $cita->hora->format('H:i') }}
                </td>
