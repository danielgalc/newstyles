...
@section('content')
    ...
    @foreach ($servicios as $servicio)
        <div id="edit_servicio_modal_{{ $servicio->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <!-- Form Editar -->
                    <form action="{{ route('servicios.update', ['id' => $servicio->id]) }}" method="post" class="p-4 md:p-5">
                        @csrf
                        @method('PUT')
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <input type="text" name="duracion" id="duracion" value="{{ $servicio->duracion }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Escribe la duración del servicio" required>
                            </div>
                            <div class="col-span-2">
                                <label for="clase"
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="edit_servicio_modal_{{ $servicio->id }}"
                            data-modal-target="confirm_delete_modal_{{ $servicio->id }}"
        ...
        <div id="confirm_delete_modal_{{ $servicio->id }}" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
