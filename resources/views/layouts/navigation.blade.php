    ...
    <div class="hidden sm:flex sm:items-center sm:ms-6">
        ...
        @else
            @if(Auth::user()->rol=='cliente')
                <x-nav-link :href="route('carrito')" :active="request()->routeIs('carrito')" class="transition-all duration-300 transform hover:text-teal-500 hover:scale-105">
            ...
            <x-slot name="trigger">
                <button class="inline-flex items-center text-center px-3 py-4 mt-1 border border-transparent leading-4 font-medium text-2xl rounded-md text-teal-300 hover:text-teal-200 focus:outline-none transition ease-in-out duration-150">
                    <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>                    <div class="ms-1">
