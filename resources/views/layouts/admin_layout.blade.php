        ...
        <div class="flex flex-col w-64 bg-teal-400 p-4 shadow-md text-xl font-inter">
            ...
            <nav class="nav-admin">
                <ul class="space-y-8 mt-4 ">
                    <li>
                        <a href={{ route('usuarios') }} class="text-white flex items-center hover:text-teal-200">
                            <svg class="svg-icon-2 mr-2 pb-1" xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
