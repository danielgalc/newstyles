        ...
        <div class="flex flex-col w-64 bg-teal-400 p-4 shadow-md text-xl font-inter">
            ...
            <nav class="nav-admin">
                <ul class="space-y-8 mt-4 ">
                    ...
                    <li>
                        <a href="javascript:" onclick="loadSection('lista_servicios')" class="text-white flex items-center hover:text-teal-200">
                    ...
                    <li>
                        <a href="javascript:" onclick="loadSection('lista_productos')" class="text-white flex items-center hover:text-teal-200">
