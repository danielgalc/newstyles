...
export default function LoggedLogos({ isMenu = false }) {
    ...
    return (
        <div className={`relative flex items-center ${isMenu ? 'flex-col mt-4' : 'mr-4'}`}>
            ...
            <div className="relative">
                ...
                {isOpen && (
                    <Menu
                        as="div"
                        className={`absolute ${isMenu ? 'left-0 mt-4' : 'right-0 mt-2'} w-48 bg-white shadow-lg rounded-md overflow-hidden z-10`}
                    >
                        <Menu.Item>
                            {({ active }) => (
                                <a
